...
void ___QuanLySinhVien___(string ten_file, string ten_file_csv, Nodeptr list, int so_giay_dem_nguoc, string _TENNGUOIDUNG) {
    while(1){
        ...
        cout << "├ 8 - Tao file.csv" << endl;
        cout << "├ 9 - Xoa file.csv" << endl;
        ...
        if(lua_chon == '1'){
            ...
            cout << GREEN << "\n[" << lua_chon << "] XOA FILE.CSV" << "\n\n";
            Xoa_file_csv(ten_file_csv);
        }
        else if(lua_chon == '0'){
            //system("cls");
...
___TruongChinh___ {
    ...
    mciSendString(TEXT("open \"singobeo.mp3\" type mpegvideo alias mp3"), NULL, 0, NULL);
